...
nrgText::nrgText(std::string textInput, std::string fontFilepathInput, int fontSizeInput, int widthInput, cocos2d::Color3B color, cocos2d::TextHAlignment hAlignmentInput)
{
	//Set textString
...
nrgText* nrgText::create(std::string textInput, std::string fontFilepath, int fontSize, int widthInput, int xCoord, int yCoord, cocos2d::Color3B color, cocos2d::TextHAlignment hAlignment)
{
...
cocos2d::Color3B nrgText::GetTextColor()
{
	return textColor;
}
...
void nrgText::ChangeColor(cocos2d::Color3B color)
{
...
void nrgText::ChangeTextSize(int size)
{
	...
	label->setColor(cocos2d::Color3B(textColor.r, textColor.g, textColor.b));
	realWidth = label->getContentSize().width;
	realHeight = label->getContentSize().height;
	scaledWidth = realWidth / scale;
	scaledHeight = realHeight / scale;
