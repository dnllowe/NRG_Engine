...
nrgList* nrgList::create(std::vector<std::string> listInput, std::string fontFile, int fontSizeInput, int spacingInput, cocos2d::Color3B textColorInput)
{
...
nrgList * nrgList::create(std::string listInput, std::string fontFile, int fontSizeInput, int spacingInput, cocos2d::Color3B textColorInput)
{
...
nrgList::nrgList(std::vector<std::string> listInput, std::string fontFile, int fontSizeInput, int spacingInput, cocos2d::Color3B textColorInput)
{
	font = fontFile;
	...
	for (int iii = 0; iii < numberOfItems; iii++)
	{
		...
		labels.at(iii)->setColor(textColorInput);
...
void nrgList::ChangeList(std::vector<std::string> listInput)
{
	...
	{
		labels.push_back(cocos2d::Label::createWithTTF(strings[iii], font, fontSize, cocos2d::Size::ZERO, cocos2d::TextHAlignment::LEFT, cocos2d::TextVAlignment::TOP));
		labels.at(iii)->setColor(textColor);
		addChild(labels.at(iii));
		labels.at(iii)->setAnchorPoint(cocos2d::Vec2(0, 0));
		labels.at(iii)->setPosition(0, (-iii * scale * letterHeight) - iii * spacing);
	}
